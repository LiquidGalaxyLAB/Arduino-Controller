...
int JoysticRanges[] = {3200,100,3200,600};        // You can check these values just by reading the analog inputs corresponding to the joystic 
                                                  //and define the value that you consider best
